...
const Unmute = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative flex w-full min-h-screen flex-col text-offwhite bg-background items-center">
        {/* z-index on the header to put it in front of the circles */}
        <div
          className={clsx(
            "w-full h-auto min-h-75",
            "flex flex-row-reverse md:flex-row items-center justify-center grow gap-8",
